...
static const char* germanRupeeNames[113] = {
    "Baht",          "Baklava",         "Bananen",         "Bitcoin",      "Bonbons",      "Bonschen",    "Brause UFOs",      "Bucks",       "Burek",      "Cent",
    "Chickenwing",   "Diamanten",       "Dinar",           "Diridari",     "Dollar",       "Draken",      "ECU",              "Eis",         "Elexit",     "Erz",
    "Erzbrocken",    "Ethereum",        "Euro",            "EXP",          "Fartcoin",     "Forint",      "Franken",          "Freunde",     "Geister",    "Gil", 
    "Gold",          "Groschen",        "Gulden",          "Haribo",       "Heller",       "Juwelen",     "Kapseln",          "Karolin",     "Kartoffeln", "Keks",   
    "Kies",          "Knete",           "Knochen",         "Knuspertaler", "Kohle",        "Kraniche",    "Kreuzer",          "Kronen",      "Kronkorken", "Lauchcoins",
    "Lira",          "Mana",            "Mark",            "Monde",        "Moos",         "Naira",       "Nugget",           "Penunze",     "Pesa",       "Peso",          
    "Pfandflaschen", "Pfennig",         "Pfund",           "Pillen",       "Pilze",        "Plastiks",    "Pok\x96""dollar",  "Poster",      "Puzzle",     "Radieschen",    
    "Rand",          "Rappen",          "Real",            "Rial",         "Riesennugget", "Riyal",       "Rubine",           "Rupien",      "Saphire",    "Schilling",     
    "Schokobon",     "Seelen",          "Septime",         "Shitcoin",     "Smaragde",     "Solana",      "Sosis",            "Steine",      "Sterne",     "Sternis",  
    "Tael",          "Taler",           "Tokens",          "Wagenchips",   "Won",          "Wumpas",      "Yen",              "Yuan",        "Zenny",      "M\x93use",   
    "M\x9Enzen",     "Kr\x9Bten",       "D\x9Bner",        "W\x9Erstchen", "Kn\x9B" "del", "R\x9Bsti",    "H\x9Brnli",        "R\x9E""ebli", "K\x9B""fte", "Bratw\x9E""rste",
    "Br\x98""tchen", "Gummib\x93""ren", "Moorh\x9E""hner"
};
